SERVICES = {
    'termite-control': {
        ...
        'pricing': [
            ('1 Kitchen/Washroom', '70–100 Sq. Ft.', '₹1,500'),
            ('1 BHK', '400–700 Sq. Ft.', '₹2,000'),
            ('2 BHK', '700–1,000 Sq. Ft.', '₹4,000'),
            ('3 BHK', '1,000–1,600 Sq. Ft.', '₹5,500'),
            ('4 BHK', '1,600–2,400 Sq. Ft.', '₹7,000'),
        ],
    ...
    'cockroach-control': {
        ...
        'pricing': [
            ('1 BHK', '400–700 Sq. Ft.', '₹999'),
            ('2 BHK', '700–1,000 Sq. Ft.', '₹1,250'),
            ('3 BHK', '1,000–1,600 Sq. Ft.', '₹1,499'),
            ('4 BHK', '1,600–2,400 Sq. Ft.', '₹1,999'),
